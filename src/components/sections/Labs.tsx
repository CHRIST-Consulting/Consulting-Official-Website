  ...
  const labs = [
    {
      ...
      description: "Advanced research facility for cognitive and behavioral studies, applying neuropsychological insights to business decisions."
    },
    {
      name: "Cybersecurity Lab",
      image: "https://images.pexels.com/photos/5380642/pexels-photo-5380642.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
      description: "Cutting-edge security research and solutions to protect businesses from evolving digital threats."
    },
    {
      ...
      description: "World-class financial research facility providing real-time market data and analytics for informed decision-making."
    },
    {
      name: "AI & Machine Learning Lab",
      image: "https://images.pexels.com/photos/8386440/pexels-photo-8386440.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
      description: "Pioneering research in artificial intelligence and machine learning applications for business optimization."
    }
  ];
    ...
    <section id="labs" className="py-20">
      <div className="section-container">
            ...
            <div className="relative overflow-hidden rounded-xl shadow-2xl">
              <div className="aspect-w-16 aspect-h-9 relative">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-primary/70 to-transparent flex flex-col justify-end p-8">
                  <h3 className="text-2xl font-bold text-white mb-2 font-heading">{labs[activeIndex].name}</h3>
                  <p className="text-white opacity-90 max-w-2xl">{labs[activeIndex].description}</p>
                </div>
              </div>
        ...
        <div className="mt-8 text-center">
          <ScrollAnimation>
            <a href="/labs" className="btn-primary">Explore Research Labs</a>
          </ScrollAnimation>
        </div>
      </div>
    </section>
