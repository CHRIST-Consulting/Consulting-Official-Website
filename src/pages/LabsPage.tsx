  ...
  const labs = [
    {
      ...
      description:
        "Our neuropsychology lab specializes in cognitive and behavioral research with direct applications to business decision-making. We study attention, memory, and executive functions to optimize workplace performance and consumer behavior.",
    },
    {
      ...
      description:
        "The cybersecurity lab develops cutting-edge solutions to protect digital assets. Our research focuses on threat detection, encryption technologies, and security protocols for enterprise applications.",
    },
    {
      ...
      description:
        "Equipped with Bloomberg terminals, this lab provides real-time financial data analysis. We conduct research on market trends, investment strategies, and economic forecasting.",
    },
    {
      ...
      description:
        "Pioneering research in artificial intelligence applications for business optimization. Our work includes natural language processing, computer vision, and predictive analytics.",
    },
    {
      ...
      description:
        "Focusing on the intersection of biology and technology, we develop innovative solutions for healthcare, agriculture, and environmental sustainability.",
    },
    {
      ...
      description:
        "Researching renewable energy technologies, energy efficiency, and sustainable business practices to drive the green economy forward.",
    },
    {
      ...
      description:
        "Specializing in big data analytics, visualization, and business intelligence. We help organizations extract meaningful insights from complex datasets.",
    },
  ];
        ...
        <div className="section-container text-center">
          <ScrollAnimation>
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Collaborate With Our Labs
            </h2>
            <p className="text-xl opacity-90 max-w-3xl mx-auto mb-8">
              Interested in partnering with us on cutting-edge research or
              application-based innovation? Let's build the future together.
            </p>
